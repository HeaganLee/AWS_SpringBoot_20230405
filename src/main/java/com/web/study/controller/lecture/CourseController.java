...
public class CourseController {
	...
	@PostMapping("/course")
	public ResponseEntity<? extends ResponseDto> saveCourse(@RequestBody CourseReqDto courseReqDto){
		
		courseService.registerLectureRegiste(courseReqDto);
	...
	@ValidAspect
	@ParamsAspect
	@GetMapping("/search/courses")                        // valid BindingResult 세트
